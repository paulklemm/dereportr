---
title: "DEReportR Differential Gene Expression Analysis"
output:
  html_document:
    code_folding: hide
    fig_height: 5
...
We work with `r length(entries_satisfying_mincount)` genes where at least one treatment has a mean gene normalized count expression of `r rmd_params$minimum_count`.
