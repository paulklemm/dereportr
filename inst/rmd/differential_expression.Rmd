...
entries_satisfying_mincount <- count_data %>%
  ...
  dplyr::filter(max_count >= rmd_params$minimum_count) %>%
...
We work with `r length(entries_satisfying_mincount)` genes where at least one sample has a minimum count of `r rmd_params$minimum_count`.
