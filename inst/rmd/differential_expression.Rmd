...
# Heatmap
p1 <- ggplot2::ggplot(mdf, ggplot2::aes(x=variable, y=car)) + 
...
grid::grid.newpage()
print(p1, vp=grid::viewport(0.8, 0.8, x=0.4, y=0.4))
print(p2, vp=grid::viewport(0.52, 0.2, x=0.45, y=0.9))
...
test %>%
  ...
  heatmaply::heatmaply(
    ...
    plot_method = "ggplot",
    label_names = c("Sample Label", "Genes", "log(10) count + 1")
  )
