...
if (params$dev == TRUE) {
  ...
  # Create a memoized function of attach biomart to speed up things
  if (!exists("m_attach_biomart")) {
    m_attach_biomart <- memoise::memoise(rmyknife::attach_biomart)
  }
} else {
  ...
  #m_attach_biomart <- rmyknife::attach_biomart
}
